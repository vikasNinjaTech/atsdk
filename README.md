...
```
composer require atsdk/php-sdk
```
...
// If we are returning from Atsdk we need to exchange the code for an
// access token.
...
//
// Setup your Atsdk object here, then set your token either via the request or from storage
